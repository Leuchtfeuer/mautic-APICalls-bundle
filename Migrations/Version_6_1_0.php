...
class Version_6_1_0 extends AbstractMigration
{
    ...
    private function getMigrator(): CampaignActionSecretMigrator
    {
        if (null === self::$migrator) {
            throw new \RuntimeException('CampaignActionSecretMigrator must be set before running Version_6_1_0 migration.');
        }
